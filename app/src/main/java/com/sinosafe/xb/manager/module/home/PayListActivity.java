 ...
 * 缴费列表
 */
public class PayListActivity extends BaseFragmentActivity {
    ...
    private PayListActivity instance;
    ...
    private void initView() {
        ...
        setTitleText("缴费列表");
        yeWuAdapter = new YeWuAdapter(this,6);
    ...
    protected void getData(){
        ...
        params.addQueryStringParameter("task_type",  "40");
