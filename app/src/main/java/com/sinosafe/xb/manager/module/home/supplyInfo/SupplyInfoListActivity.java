 ...
 * 补充资料列表
 */
public class SupplyInfoListActivity extends BaseFragmentActivity {
    ...
    private SupplyInfoListActivity instance;
    private int pageNum = 1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_supplyinfo_list);
        instance = this;
    ...
    private void initView() {
        ...
        setTitleText("补充资料列表");
        yeWuAdapter = new YeWuAdapter(this,5);
        ...
        yeWuAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onClick(View view, int position, Object item) {
                ...
                if("2".equals(prdType))
                    IntentUtil.gotoActivityForResult(instance,MicroCreditDetailActivity.class,bundle,10000);
                else
    ...
    protected void getData(){
        ...
        params.addQueryStringParameter("task_type",  "30");
